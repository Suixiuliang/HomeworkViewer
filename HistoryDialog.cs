...
namespace HomeworkViewer
{
    public class HistoryDialog : Form
    {
        ...
        public HistoryDialog()
        {
            ...
            Label lblYear = new Label { Text = "年份:", Location = new System.Drawing.Point(20, 20), AutoSize = true };
            cmbYear = new ComboBox { Location = new System.Drawing.Point(80, 17), Width = 150, DropDownStyle = ComboBoxStyle.DropDownList };
            ...
            Label lblMonth = new Label { Text = "月份:", Location = new System.Drawing.Point(20, 50), AutoSize = true };
            cmbMonth = new ComboBox { Location = new System.Drawing.Point(80, 47), Width = 150, DropDownStyle = ComboBoxStyle.DropDownList };
            cmbMonth.SelectedIndexChanged += (s, e) => UpdateDays();

            Label lblDay = new Label { Text = "日期:", Location = new System.Drawing.Point(20, 80), AutoSize = true };
            cmbDay = new ComboBox { Location = new System.Drawing.Point(80, 77), Width = 150, DropDownStyle = ComboBoxStyle.DropDownList };

            btnOk = new Button { Text = "确定", Location = new System.Drawing.Point(80, 120), Width = 70 };
            btnOk.Click += (s, e) => ConfirmSelection();

            btnCancel = new Button { Text = "取消", Location = new System.Drawing.Point(160, 120), Width = 70 };
            ...
            if (cmbYear.Items.Count > 0) UpdateMonths();
        }
